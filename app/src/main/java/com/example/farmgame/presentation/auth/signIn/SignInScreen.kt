package com.example.FarmGame.presentation.auth.signIn
...
import com.example.FarmGame.data.util.AuthState
...
import com.example.FarmGame.presentation.components.PasswordField
...
//                )
            ...
            if (signInState is AuthState.Error) TextError(signInState.message)
