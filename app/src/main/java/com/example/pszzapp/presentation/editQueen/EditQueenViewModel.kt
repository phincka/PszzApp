...
import com.example.pszzapp.presentation.feeding.FeedingScreenState
...
@KoinViewModel
class EditQueenViewModel(
    id: String,
    private val getHiveByIdUseCase: GetHiveByIdUseCase,
) : ViewModel() {
    private val _createHiveState: MutableStateFlow<CreateHiveState> =
        MutableStateFlow(CreateHiveState.None)
...
//                FeedingScreenState.Error("Failed: Nie znaleziono przeglądu o podanym ID")
//        }
//    }
}
